...
def migrate_db():
    ...
    if 'whatsapp_campaigns' not in existing:
        ...
        em_camps = [
            (org_id, 'Newsletter Junho — Dicas de Verão', 'all', 'Dicas de Verão + Oferta Especial Primeplas',
             'loyal', 'sent', 1240, 1180, 486, 142, 38, 12, 7220.00, None, datetime_ago(-5)),
            (org_id, 'Carrinho Abandonado — Recuperação', 'at_risk', 'Você esqueceu seu Cooler 🧊',
             'at_risk', 'sent', 89, 84, 62, 41, 18, 3, 3420.00, None, datetime_ago(-2)),
            (org_id, 'Onboarding Novos Clientes', 'new', 'Bem-vindo à família Primeplas! 🎉',
             'new', 'sent', 156, 148, 131, 67, 22, 1, 4180.00, None, datetime_ago(-10)),
            (org_id, 'Reengajamento 90 dias', 'lost', 'Sentimos sua falta, {nome}',
        ...
        for s in skus:
            qty, reserved, min_s, cost, price, daily, status = s[3], s[4], s[5], s[6], s[7], s[8], s[10]
            avail = qty - reserved
